...
const Footer = () => {
  ...
  return (
    <footer className="col-span-12 flex sm:flex-wrap flex-col bg-tertiary">
      <div className="flex justify-around" style={{ height: "50vh" }}>
      ...
      <div
        className="flex bg-primary justify-around items-center"
        style={{ height: "10vh" }}
      >
        <div className="flex items-center">
          <Image height={60} width={60} src={images.footer} />
          <span className="text-white text-center px-4">
            Derechos de autor © 2023 Exsis Digital S.A.S.. Reservados todos los
            derechos.
          </span>
        </div>
        <div className="flex gap-x-2">
          <Image height={30} width={30} src={images.youtube2} />
          <Image height={30} width={30} src={images.facebook2} />
          <Image height={30} width={30} src={images.instagram2} />
          <Image height={30} width={30} src={images.email2} />
        </div>
      </div>
    </footer>
  );
